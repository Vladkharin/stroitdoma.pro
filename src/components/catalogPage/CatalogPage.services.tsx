import { typeAdditionalServices, typeChoiceTypeHouse } from "./CatalogPage";
...
export const fetchAdditionalServices = async (
  setAdditionalServices: React.Dispatch<React.SetStateAction<typeAdditionalServices | undefined>>
) => {
